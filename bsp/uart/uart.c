...
bool UART_GetStatusFlag(UART_Type *base, uart_status_flag_t flag)
{
    ...
    uart_reg = (uint32_t *)((uint32_t)base + ((uint32_t)flag >> 16));
    return (bool)(((*uart_reg) >> ((uint32_t)flag & 0x1FU)) & 0x1U);
}
...
void UART_ClearStatusFlag(UART_Type *base, uart_status_flag_t flag)
{
    ...
    uart_reg = (uint32_t *)((uint32_t)base + ((uint32_t)flag >> 16));
    uart_mask = (1U << ((uint32_t)flag & 0x1FU));
...
void UART_EnableInterrupts(UART_Type *base, uart_interrupt_enable_t mask)
{
    ...
    if (0X3F & (uint32_t)mask)
    {
        base->UCR1 |= (((uint32_t)mask << UART_UCR1_ADEN_SHIFT) & UART_UCR1_ADEN_MASK) |
                      ((((uint32_t)mask >> 1) << UART_UCR1_TRDYEN_SHIFT) & UART_UCR1_TRDYEN_MASK) |
                      ((((uint32_t)mask >> 2) << UART_UCR1_IDEN_SHIFT) & UART_UCR1_IDEN_MASK) |
                      ((((uint32_t)mask >> 3) << UART_UCR1_RRDYEN_SHIFT) & UART_UCR1_RRDYEN_MASK) |
                      ((((uint32_t)mask >> 4) << UART_UCR1_TXMPTYEN_SHIFT) & UART_UCR1_TXMPTYEN_MASK) |
                      ((((uint32_t)mask >> 5) << UART_UCR1_RTSDEN_SHIFT) & UART_UCR1_RTSDEN_MASK);
    }
    if (0X700U & (uint32_t)mask)
    {
        base->UCR2 |= ((((uint32_t)mask >> 8) << UART_UCR2_ESCI_SHIFT) & UART_UCR2_ESCI_MASK) |
                      ((((uint32_t)mask >> 9) << UART_UCR2_RTSEN_SHIFT) & UART_UCR2_RTSEN_MASK) |
                      ((((uint32_t)mask >> 10) << UART_UCR2_ATEN_SHIFT) & UART_UCR2_ATEN_MASK);
    }
    if (0x3FF000 & (uint32_t)mask)
    {
        base->UCR3 |= ((((uint32_t)mask >> 12) << UART_UCR3_DTREN_SHIFT) & UART_UCR3_DTREN_MASK) |
                      ((((uint32_t)mask >> 13) << UART_UCR3_PARERREN_SHIFT) & UART_UCR3_PARERREN_MASK) |
                      ((((uint32_t)mask >> 14) << UART_UCR3_FRAERREN_SHIFT) & UART_UCR3_FRAERREN_MASK) |
                      ((((uint32_t)mask >> 15) << UART_UCR3_DCD_SHIFT) & UART_UCR3_DCD_MASK) |
                      ((((uint32_t)mask >> 16) << UART_UCR3_RI_SHIFT) & UART_UCR3_RI_MASK) |
                      ((((uint32_t)mask >> 17) << UART_UCR3_RXDSEN_SHIFT) & UART_UCR3_RXDSEN_MASK) |
                      ((((uint32_t)mask >> 18) << UART_UCR3_AIRINTEN_SHIFT) & UART_UCR3_AIRINTEN_MASK) |
                      ((((uint32_t)mask >> 19) << UART_UCR3_AWAKEN_SHIFT) & UART_UCR3_AWAKEN_MASK) |
                      ((((uint32_t)mask >> 20) << UART_UCR3_DTRDEN_SHIFT) & UART_UCR3_DTRDEN_MASK) |
                      ((((uint32_t)mask >> 21) << UART_UCR3_ACIEN_SHIFT) & UART_UCR3_ACIEN_MASK);
    }
    if (0x3F000000 & (uint32_t)mask)
    {
        base->UCR4 |= ((((uint32_t)mask >> 24) << UART_UCR4_ENIRI_SHIFT) & UART_UCR4_ENIRI_MASK) |
                      ((((uint32_t)mask >> 25) << UART_UCR4_WKEN_SHIFT) & UART_UCR4_WKEN_MASK) |
                      ((((uint32_t)mask >> 26) << UART_UCR4_TCEN_SHIFT) & UART_UCR4_TCEN_MASK) |
                      ((((uint32_t)mask >> 27) << UART_UCR4_BKEN_SHIFT) & UART_UCR4_BKEN_MASK) |
                      ((((uint32_t)mask >> 28) << UART_UCR4_OREN_SHIFT) & UART_UCR4_OREN_MASK) |
                      ((((uint32_t)mask >> 29) << UART_UCR4_DREN_SHIFT) & UART_UCR4_DREN_MASK);
    }
}
